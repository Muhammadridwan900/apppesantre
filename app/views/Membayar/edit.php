      ...
      <div class="row">
        <div class="col">
          ...
          <div class="card p-0 mt-2 shadow-sm" style="background-color:  #e4e6e7;">
            <p class="ps-3 mt-1 mb-1 fw-bold shadow border"><span style="margin-right: 21px;">NAMA</span>: <?= $data['santri']['nama'];?><br><span class="me-4">KELAS</span>: <?= $data['santri']['kelas'] . ' ' . $data['santri']['marhalah'] . ' ' . $data['santri']['ruang']  ;?><br><span style="margin-right: 13px;">KAMAR</span>: <?= $data['santri']['kamar'];?></p>
          </div>
        ...
        <div class="row">
          ...
          <ul class="list-group">
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center">JANUARI<span class="badge fw-bold rounded fs-6">
              <select>
                <option>Rp : <?= $data['santri']['spp_februari'];?></option>
                <option>-- -- --</option>
              </select></span></li>
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center">NOVEMBER<span class="badge fw-bold rounded fs-6">
              <select>
                <option>Rp : <?= $data['santri']['spp_november'];?></option>
                <option>-- -- --</option>
              </select></span></li>
            <li class="list-group-item d-flex justify-content-between align-items-center">DESEMBER<span class="badge fw-bold rounded fs-6">
              <select>
                <option>Rp : <?= $data['santri']['spp_desember'];?></option>
                <option>-- -- --</option>
              </select></span></li>
          </ul>
          </div>
